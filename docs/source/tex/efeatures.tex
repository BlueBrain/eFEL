...
\begin{efeature}
  ...
  \mybox{remarks:}{
  The regular feature E29 determins $R_\mathrm{in}$ far more accurately.
  }
\end{efeature}
...
\begin{efeature}
  ...
  Get the points (\myid{stimulus current}, \myid{steady state hyper}) for all repetitions and iterations of the stimulus protocol \myid{IV} and fit a straight line.
  Yield the slope.
...
\begin{efeature}
  ...
  Take the mean of \myid{time constant} over all repetitions and iterations of the stimulus protocol \myid{IV}
...
\begin{efeature}
  ...
  Calculate the standard deviations of all values of \myid{time constant} obtained on different repetitions and iterations of the stimulus protocol \myid{IV}.
