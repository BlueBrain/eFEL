# -*- coding: utf-8 -*-
#
# eFEL documentation build configuration file, created by
...
version = efel.__version__
# The full version, including alpha/beta/rc tags.
release = efel.__version__
...
latex_documents = [
    ('index', 'eFEL.tex', u'eFEL Documentation',
     u'BBP, EPFL', 'manual'),
]
...
man_pages = [
    ('index', 'efel', u'eFEL Documentation',
     [u'BBP, EPFL'], 1)
]
...
texinfo_documents = [
    ('index', 'eFEL', u'eFEL Documentation',
     u'BBP, EPFL', 'eFEL', 'One line description of project.',
     'Miscellaneous'),
]
