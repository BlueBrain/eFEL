...
int LibV5::number_initial_spikes(mapStr2intVec& IntFeatureData,
  ...
  if (retVal)
    ...
    retVal =
        getDoubleParam(DoubleFeatureData, "initial_perc", initial_perc);
    {
      if (retVal <= 0) return -1;
    };
...
int LibV5::AP1_amp(mapStr2intVec& IntFeatureData,
  ...
  int retVal, nSize;
  retVal =
      CheckInDoublemap(DoubleFeatureData, StringData, "AP1_amp", nSize);
  if (retVal) {
    return nSize;
  } else {
...
int LibV5::AP2_amp(mapStr2intVec& IntFeatureData,
  ...
  int retVal, nSize;
  retVal =
      CheckInDoublemap(DoubleFeatureData, StringData, "AP2_amp", nSize);
  if (retVal) {
    return nSize;
  } else {
